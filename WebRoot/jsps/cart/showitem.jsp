...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/Book_load.action?bid=${cartItem.book.bid }'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_b }'/>"/></a>
		</td>
		<td align="left">
			<a href="<c:url value='/Book_load.action?bid=${cartItem.book.bid }'/>"><span>${cartItem.book.bname }</span></a>
		</td>
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="湖南省 长沙市 开福区 福元路一号 5-1-1"/>
		</td>
	</tr>
	<tr>
