...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/goods/User_ajaxValidateLoginname.action",//要请求的servlet
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url:"/goods/User_ajaxValidateEmail.action",//要请求的servlet
...
function validateVerifyCode() {
	 ...
	 */
	$.ajax({
		url:"/goods/User_ajaxValidateVerifyCode.action",//要请求的servlet
