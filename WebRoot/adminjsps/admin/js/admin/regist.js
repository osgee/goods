...
function validateAdminname() {
	 ...
	 */
	$.ajax({
		url:"/Admin_ajaxValidateAdminname.action",//要请求的servlet
		data:{method:"ajaxValidateAdminname", adminname:value},//给服务器的参数
		type:"POST",
		dataType:"json",
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url:"/Admin_ajaxValidateEmail.action",//要请求的servlet
...
function validateVerifyCode() {
	 ...
	 */
	$.ajax({
		url:"/Admin_ajaxValidateVerifyCode.action",//要请求的servlet
